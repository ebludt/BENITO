		...
		union(){
			...
			//rueda
				...
				if (pos_rueda!=3){
					for (i=[0:dientes]) 
					{
					translate([(25)*cos((360/dientes*i)+360/dientes/2),(25)*sin((360/dientes*i)+360/dientes/2),-1])
					cylinder(r=(25)/4, h=100, $fn=20);
...
//union()
{
	...
	if (tipo_rueda==1) 
	{
		for (i=[0:dientes-1])
		{
			...
			cylinder(r=4.4/2, h=100, $fn=20,center=true);
			//translate([distanciadientes/2*cos(angulodientes*i),distanciadientes/2*sin(angulodientes*i),0])
